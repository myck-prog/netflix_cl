    ...
    >
      <>
        ...
        <div className="relative pt-[56.25%]">
          <ReactPlayer
            url={`https://www.youtube.com/watch?v=${trailer}`||`https://www.youtube.com/watch?v=WEhIRofi1z0&ab_channel=InsertBruh`}
            width="100%"
            height="100%"
        ...
        <div className="flex spacex-16 rounded-b-md bg-[#181818] px-10 py-8">
          <div className="space-y-6 text-lg">
            ...
            {/* set medium breakpoint as side by side */}
